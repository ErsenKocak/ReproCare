...
class _$LoginResponseModelImpl implements _LoginResponseModel {
  _$LoginResponseModelImpl({this.email, this.token});
  ...
  @override
  String toString() {
    return 'LoginResponseModel(email: $email, token: $token)';
  }
...
abstract class _LoginResponseModel implements LoginResponseModel {
  factory _LoginResponseModel({final String? email, final String? token}) =
