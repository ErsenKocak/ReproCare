...
/// @nodoc
@JsonSerializable()
class _$UserDeviceEntityImpl implements _UserDeviceEntity {
  ...
  @override
  String toString() {
    return 'UserDeviceEntity(id: $id, userId: $userId, name: $name, model: $model, systemVersion: $systemVersion, deviceId: $deviceId, physicalDevice: $physicalDevice)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UserDeviceEntityImpl &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, userId, name, model,
      systemVersion, deviceId, physicalDevice);
...
abstract class _UserDeviceEntity implements UserDeviceEntity {
  factory _UserDeviceEntity(
      ...
      final String? systemVersion,
      final String? deviceId,
      final bool? physicalDevice}) = _$UserDeviceEntityImpl;
